...
export const createCardNotice = ({offer, author}) => {
  ...
  if (offer.features) {
    ...
    noticeElement.querySelector('.popup__features').remove();
  }

  if (offer.description) {
    noticeElement.querySelector('.popup__description').textContent = offer.description;
  } else {
    noticeElement.querySelector('.popup__description').remove();
  }
  ...
  if (offer.photos) {
    ...
    noticeElement.querySelector('.popup__photos').remove();
  }
